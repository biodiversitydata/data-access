...
## Also, you may encounter encoding issues. 

```{r}
#| error: true
#| echo: true

t <- read.csv("data/36266.txt", sep="\t")
```

```{r}
#| echo: true

readr::guess_encoding("data/36266.txt")
```

```{r}
#| echo: true

t <- utils::read.csv2(file = file("data/36266.txt", encoding = 'ISO-8859-1'), sep="\t")
colnames(t)
```

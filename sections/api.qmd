...
{{< fa circle-right >}} &nbsp; Example with the **OpenStreetMap Nominatim** [API](https://nominatim.openstreetmap.org/ui/search.html)
...
request  <- paste0(endpoint, "?q=", address)
request  <- paste0(request, "&format=json&limit=1")
request
...
maps::map(regions = "France", fill = TRUE, col = "black")
points(x = content$"lon", y = content$"lat", pch = 19, cex = 1, col = "red")
text(x = content$"lon", y = content$"lat", labels = content$"name", pos = 2, col = "white", family = "serif")
```
:::
::::

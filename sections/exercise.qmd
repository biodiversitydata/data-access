...
**Part 2**: Download [GBIF](https://www.gbif.org/) occurrences for two bat species endemic to the islands of New Zealand: 
...
**Bonus A**: Download New Zealand boundaries from [GADM](https://gadm.org/) (**GeoJSON Level 0**).

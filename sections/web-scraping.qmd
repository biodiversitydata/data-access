...
**N.B.** This section is not necessarily interesting for web scraping
:::
...
top10 <- dplyr::rename(top10,
                       pop2023 = population_de_reference)
...
# Convert 'rang2023' to numeric ----
top10$"rang2023" <- as.integer(top10$"rang2023")
```
:::
...
# Convert 'pop2023' to numeric ----
top10$"pop2023" <- gsub(" ", "", top10$"pop2023")
top10$"pop2023" <- as.numeric(top10$"pop2023")
